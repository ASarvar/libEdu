...
import BannerImage from '../../../public/images/home-1/hero/hero-01.png';
      ...
      <section id="home" className="hero-section hero-1">
        <div className="hero-image wow img-custom-anim-right">
          ...
          <div className="shape-2">
            <Image src={BannerShape2} alt="img" />
          </div>
        </div>
          ...
          <div className="row g-4">
            <div className="col-xl-6 col-lg-12">
              <div className="hero-content">
                ...
                <h1 className="wow fadeInUp" data-wow-delay=".2s">Empower your Business with Our Solutions</h1>
