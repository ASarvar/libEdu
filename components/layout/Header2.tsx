...
import MobileLogo from '../../public/images/logo_white.svg';
import LogoMain from '../../public/images/logo_white.svg';
    ...
    return (
        ...
        <header className={`main-header header-style-one header-2 ${scroll ? "fixed-header" : ""}`}>
            ...
            <div className="auto-container">
                ...
                {/* <!--Logo--> */}
                <div className="logo">
                    <Link href="/"><Image src={Logo2} alt="Kutubxona Logo" width={150} height={40} className="sticky-logo-img" /></Link>
                </div>
                <div className="nav-outer">
