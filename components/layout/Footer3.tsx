...
function Footer3() {
  ...
  return (
    <footer
      className="footer-section-2 footer-section-4 fix footer-bg bg-cover"
    ...
    >
      ...
      <div className="auto-container">
              ...
              <div className="footer-widget-items mt-30">
                ...
                <div className="footer-content">
                  ...
                  <ul className="contact-list-2">
                    ...
                    <li>
                      <Link href="mailto:info@kutubxona.uz">
                        info@kutubxona.uz
                      </Link>
                    </li>
                  </ul>
              ...
              <div className="footer-widget-items mt-30">
                ...
                <div className="user-links-area">
                  <ul className="user-links">
                    <li>
                      <Link href="/">{t("footerSection.home")}</Link>
                    </li>
                    <li>
                      <Link href="/about">{t("footerSection.about")}</Link>
                    </li>
                    <li>
                      <Link href="/catalog">{t("footerSection.services")}</Link>
                    </li>
                    <li>
                      <Link href="/contact">
            ...
            >
              <div className="footer-widget-items mt-30">
                ...
                <ul className="user-links">
                  <li>
                    <Link href="/contact">
                      {t("footerSection.customerSupport")}
                    </Link>
                  </li>
                  <li>
                    <Link href="/about">{t("footerSection.privacy")}</Link>
                  </li>
                  <li>
                    <Link href="/about">{t("footerSection.terms")}</Link>
                  </li>
                  <li>
                    <Link href="/contact">{t("footerSection.helpCenter")}</Link>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <p className="footer-text wow fadeInUp" data-wow-delay=".3s">
          {t("footer.copyright")} © 2026 Kutubxona.{" "}
